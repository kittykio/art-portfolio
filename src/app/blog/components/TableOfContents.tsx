...
export const TableOfContents = ({ headings, postItem, setPostItem }: TOCProps) => {
            ...
            <div className="flex items-center gap-1">
              {hasChildren && (
                <button
                  ...
                  className="text-dglg-700 hover:text-flame-500 transition"
                >
  ...
  return (
    <aside className="relative max-h-fit min-w-[200px]">
      <div className="overflow-y-auto isolate bg-wb-blur-50 backdrop-blur-xl border border-wb-blur-10 rounded-xl shadow-md px-4 py-8 text-sm shadow-[inset_1px_1px_2px_rgba(255,255,255,0.4),inset_-1px_-1px_2px_rgba(0,0,0,0.2)] drop-shadow-[0_4px_12px_rgba(0,0,0,0.25)]">
        <div className="flex items-center justify-between mb-3">
          <p className="font-bodyBold text-dglg-700 flex items-center gap-2">
