    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        {hasHeader ? (
          ...
          <div className="flex flex-col items-center mt-20 mb-12 gap-12">
            {title ? (
              // Animated main title.
              <m.h2
                ...
                className="font-drool text-6xl font-bodyBold uppercase tracking-wide text-dglg-900 text-center"
              >
                {title}
              </m.h2>
            ) : (
            ...
            {subtitle ? (
              ...
              <m.div
                ...
                className="text-lg max-w-3xl text-wrap text-center"
              >
                {subtitle}
              </m.div>
            ) : (
